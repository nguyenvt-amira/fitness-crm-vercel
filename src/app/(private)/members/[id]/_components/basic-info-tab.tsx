    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <InfoRow
            label="生年月日・年齢"
            value={
              basic?.birthday ? `${formatDate(basic.birthday)}（${basic.age ?? '—'}歳）` : undefined
            }
          />
          <InfoRow
            label="性別"
          ...
          {basic?.emergency_contact && (
            <>
              ...
              <InfoRow label="緊急連絡先（続柄）" value={basic.emergency_contact.relationship} />
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <InfoRow
            label="検証日時"
            value={member.ekyc?.verified_at ? formatDateTime(member.ekyc.verified_at) : undefined}
          />
        ...
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-1 flex flex-wrap gap-4">
              ...
              <span>プッシュ通知: {member.consent?.marketing_consent?.push ? 'ON' : 'OFF'}</span>
            </div>
          </div>
          <div className="md:col-span-2">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            <p className="text-muted-foreground text-sm">定期アンケート（満足度調査の最新結果）</p>
            <p className="mt-1">—</p>
          </div>
        </CardContent>
      </Card>
