 ...
 * 回答ステータス
 */
export const SurveyResponseStatus = { COMPLETED: 'completed', PARTIAL: 'partial' } as const;
 ...
 * アンケート回答一覧クエリ
 */
export type GetSurveyResponsesQuery = {
    page?: number;
    limit?: number;
    /**
     * アンケート名で検索
 ...
 * アンケート回答一覧レスポンス
 */
export type GetSurveyResponsesResponse = {
    responses: Array<{
        /**
         * 回答ID
         */
 ...
 * 設問集計の選択肢統計
 */
export type SurveyAnalyticsChoiceStat = {
    /**
     * 選択肢ラベル
     */
    label: string;
 ...
 * 自由記述の回答サンプル
 */
export type SurveyAnalyticsFreeTextSample = {
    /**
     * 自由記述回答
     */
    text: string;
 ...
 * 選択式設問の集計結果
 */
export type SurveyAnalyticsSelectQuestion = {
    /**
     * 選択式設問
     */
    kind: 'select';
 ...
 * 自由記述設問の集計結果
 */
export type SurveyAnalyticsFreeTextQuestion = {
    /**
     * 自由記述設問
     */
    kind: 'free_text';
 ...
 * 集計対象コンテキスト
 */
export type SurveyAnalyticsContext = {
    /**
     * アンケートID
     */
    survey_id: string;
 ...
 * 集計サマリー
 */
export type SurveyAnalyticsKpi = {
    /**
     * 総回答数
     */
    total_responses: number;
 ...
 * アンケート集計クエリ
 */
export type GetSurveyAnalyticsQuery = {
    /**
     * アンケート名で検索
     */
    search?: string;
...
export type SurveyCsvExportRequest = {
    /**
     * アンケート名で検索
     */
    search?: string;
 ...
 * アンケート集計クエリ
 */
export type SurveyAnalyticsCsvExportRequest = {
    /**
     * アンケート名で検索
     */
    search?: string;
 ...
 * CSV出力レスポンス
 */
export type SurveyCsvExportResponse = {
    message: string;
    filename: string;
    /**
     * CSV本文
