...
| **Context is controllable**         | ✅                      | Feature specs are self-contained files. SpecKit skills read only the relevant spec + constitution + playbook — not the whole codebase.             |
